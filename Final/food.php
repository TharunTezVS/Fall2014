...
<html lang="en">
	...
	<body background="http://wallalay.com/wp-content/uploads/2014/06/Solid-Blue-4.jpg" class = "img-responsive" alt="Responsive image">
		...
		<footer>
			<center>
				<a class="btn btn-success" data-toggle="modal" data-target="#myModal" href="foodform.html"> <i class="glyphicon glyphicon-plus"></i> Add </a>
				<a class="btn btn-success" data-toggle="modal" data-target="#myModal" href="#"> <i class="glyphicon glyphicon-minus"></i> Delete </a>
			</center>
		</footer>
